...
export default class InvoiceDetails extends React.Component{
    ...
    render() {
        ...
        let bills = this.context.bills.find(res => res.billsId === this.props.match.params.id);
        ...
        return (
            <main className='invoicePage'>
                ...
                <div className='makePaymentTo'>
                    ...
                    <p>{manager.street}</p>
                    <p>{manager.city}, {manager.state} {manager.zip}</p>
                </div>
                ...
                */}
                ...
                <p id='backLink'><Link to='/Billing'>Back</Link></p>
